...
def _list_known_agents(known_urls: list) -> dict:
    ...
    url_to_agent = {
        "http://127.0.0.1:8001": {"name": "Time Agent", "description": "Current time and date information"},
        "http://127.0.0.1:8002": {"name": "Calculator Agent", "description": "Mathematical calculations"},
        "http://127.0.0.1:8003": {"name": "Web Agent", "description": "Web searches and Wikipedia lookups"},
    }
